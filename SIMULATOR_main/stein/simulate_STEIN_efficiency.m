...
%experiments: regular Qi 1.0, resonant Qi 1.0, Qi+ version 1, Qi+ version 2, Qi optimal
improved_rx = [0, 0, 1, 1, 2];
improved_circ = [false, true, false, false, false];
version = [2, 2, 1, 2, 2];
line_style = {'-b','--r','om','*k','.g'};
...
for exp = 1:length(improved_rx)
	...
	P = params.R(1)*abs(sBC_TX1+sBC_TX2).^2 + Prx; %power dissipated by the entire system (TX and RX)
	eff = Prx./P;
...
legend('Regular Qi', 'Resonant Ping', 'RX-Optimized v1', 'RX-Optimized v2', 'Optimal (estimation)');