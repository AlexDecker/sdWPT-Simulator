classdef magMIMOLinearBattery < linearBattery
	...
	methods
		function obj = magMIMOLinearBattery(rlFile,ocvFile,Rc,Rd,Q0,Qmax,Rmax,fase1Limit,...
			constantCurrent_min,constantCurrent_max,constantVoltage,limitToBegin, plotData)
		...
		function [obj,DEVICE_DATA] = updateCharge(obj,charge_current,discharge_current,...
