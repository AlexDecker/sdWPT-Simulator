...
%savefile (bool) salvar depois da execução?
%plotAnimation (bool) mostrar a animação?
%evalMutualCoupling (bool) calcular as interações das bobinas (operação custosa)?
%file (str) arquivo para onde irão os ambientes
%maxV (m) amplitude das variações de translação
%maxR (rad) amplitude das variações de rotação
