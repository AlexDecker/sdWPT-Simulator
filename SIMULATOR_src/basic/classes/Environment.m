...
classdef Environment
    ...
    methods
        ...
        %groups - each element of this vector corresponds to one of the system's circuit, which
        %is composed by a RLC ring attached to an arbitrary number of parallel coils
